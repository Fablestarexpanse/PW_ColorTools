    ...
    def define_schema(cls) -> io.Schema:
        return io.Schema(
            ...
            inputs=[
                ...
                io.Float.Input("halation_radius", default=28.0, min=1.0, max=200.0, step=1.0),
                io.Float.Input("halation_threshold", default=0.70, min=0.0, max=1.0, step=0.01),
                io.Float.Input(
                    "vignette",
                    default=0.0,
                    min=-1.0,
                ...
                io.Float.Input("vignette_midpoint", default=0.5, min=0.0, max=1.0, step=0.01, optional=True),
                io.Float.Input("vignette_feather", default=0.6, min=0.0, max=1.0, step=0.01, optional=True),
                io.Float.Input(
                    "vignette_roundness",
                    default=1.0,
                    min=0.1,
